...
def protective_squeeze(x: numpy.ndarray):
    ...
    if len(x.shape) > 3:  # 如果维度超过3
        ...
        if n_imgs > 1:  # 如果图像数量大于1
            img_shape = (-1,) + img_shape  # 调整形状
